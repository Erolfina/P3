...
final class Messages {
    ...
    func messageChooseYourCharacters() {
        ...
        print ("""
            ...
            🪓 3 - Dwarf : \(dwarf.description) || Points of Life : \(dwarf.pointsOfLifeOfCharacter) || Weapon : \(dwarf.weapon) || Weapon damages : \(dwarf.weaponDamages) || Healing ? \(dwarf.healing) ||
            🛡 4 - Colossus : \(colossus.description) || Points of Life : \(colossus.pointsOfLifeOfCharacter) || Weapon : \(colossus.weapon) || Weapon damages : \(colossus.weaponDamages) || Healing ? \(colossus.healing) ||
""")
    }
